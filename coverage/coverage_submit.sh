...
then
    ...
    if [[ $mode == "g4" ]]; then
	snakemake --snakefile bedsnake_coverage.py --configfile config_coverage/config_g4hunter.yaml --latency-wait 5 --cores $j
    elif [[ $mode == "regex" ]]; then
	snakemake --snakefile bedsnake_coverage.py --configfile config_coverage/config_regex.yaml --latency-wait 5 --cores $j
    elif [[ $mode == "tandem" ]]; then
	snakemake --snakefile bedsnake_coverage.py --configfile config_coverage/config_tandem.yaml --latency-wait 5 --cores $j
    elif [[ $mode == "IR" ]]; then
